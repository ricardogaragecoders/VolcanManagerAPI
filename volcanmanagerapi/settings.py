...
THALESAPI_ENCRYPTED_K03_KID = env.str('THALESAPI_ENCRYPTED_K03_KID', '')
THALESAPI_ENCRYPTED_K06_AUTH_KID = env.str('THALESAPI_ENCRYPTED_K06_AUTH_KID', '')
...
URL_AZ7_ALTA_ENTE = env.str('URL_AZ7_ALTA_ENTE', '/web/services/Alta_Ente_1')
